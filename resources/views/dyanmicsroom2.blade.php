...
<html lang="en">
  ...
  <script>
    ...
    channel.bind('my-event', function(data) {
      ...
      if ( (data.message)['2'] == window.location.href && (data.message)['1'] == 'CODIGO1') {
            $("#img").show();
            $("#img2").show();
            $('#change').text('Come onnnnnnnnnnnnnnnnnnnn!');
      } else if ( (data.message)['2'] == window.location.href && (data.message)['1'] == 'CODIGO2' ) {
            $("#img3").show();
            $("#img4").show();
            $('#change').text('Come onnnnnnnnnnnnnnnnnnnn2!');
  ...
  <body>
    ...
    <div class="d-flex justify-content-center flex-column col-sm">
      <button type="button" class="collapsible btn btn-warning">Open Collapsible</button>
      <div class="content">
        <p id="change" style="display: none;" class="text-center">Lorem ipsum..asdsdadsadsaadsadsadsdsadsd.</p>
      </div>
    </div>
